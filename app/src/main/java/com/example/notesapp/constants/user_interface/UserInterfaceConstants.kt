...
object UserInterfaceConstants {
    ...
    const val NOTE_TITLE_BEING_MANIPULATED_FIELD_NAME: String = "noteTitleBeingManipulated"

    const val NOTE_BODY_BEING_MANIPULATED_FIELD_NAME: String = "noteBodyBeingManipulated"
