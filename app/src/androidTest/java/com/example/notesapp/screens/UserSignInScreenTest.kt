...
import com.example.notesapp.constants.user_interface.UserInterfaceConstants.NO_AVAILABLE_INTERNET_ERROR_MESSAGE
...
import com.example.notesapp.concerns.mocks.UserCreationUserViewModelMock
...
class UserSignInScreenTest {
    ...
    fun testIfNotAvailableInternetErrorMessageIsDisplayedWhenInternetIsNotAvailableOnUserCreationSubmission() {
        ...
        composeTestRule.onNodeWithText(NO_AVAILABLE_INTERNET_ERROR_MESSAGE).assertExists()
    }
